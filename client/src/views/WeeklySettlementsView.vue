            ...
            <table class="inner-table">
              ...
              <tbody>
                <tr v-for="entry in month.entries" :key="'w' + entry.id">
                  ...
                  <td class="action-cell no-print"><button class="btn-del" aria-label="Usuń wpis" @click="handleDeleteEntry('work', entry.id)">×</button></td>
                </tr>
            ...
            <table class="inner-table">
              ...
              <tbody>
                <tr v-for="payment in month.payments" :key="'p' + payment.id" class="row-payment">
                  ...
                  <td class="action-cell no-print"><button class="btn-del" aria-label="Usuń wpis" @click="handleDeleteEntry('payment', payment.id)">×</button></td>
                </tr>
