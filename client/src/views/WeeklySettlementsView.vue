            ...
            <table class="inner-table">
              ...
              <tbody>
                <tr v-for="entry in month.entries" :key="'w' + entry.id">
                  ...
                  <td class="action-cell no-print"><button type="button" class="btn-del" @click="handleDeleteEntry('work', entry.id)" aria-label="Usuń wpis">×</button></td>
                </tr>
            ...
            <table class="inner-table">
              ...
              <tbody>
                <tr v-for="payment in month.payments" :key="'p' + payment.id" class="row-payment">
                  ...
                  <td class="action-cell no-print"><button type="button" class="btn-del" @click="handleDeleteEntry('payment', payment.id)" aria-label="Usuń wpis">×</button></td>
                </tr>
