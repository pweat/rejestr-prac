...
<template>
  <div class="container">
    ...
    <div class="table-container">
          ...
          <tr v-for="praca in prace" :key="praca.id">
            ...
            <td class="actions-cell">
              <RouterLink :to="`/praca/${praca.id}`">
                <button class="pokaż">Pokaż</button>
              </RouterLink>
      ...
      <div v-if="prace.length === 0" class="empty-table-message"><p>Brak pasujących wyników.</p></div>
    </div>
