...
// ZMIANA: Poprawka formatowania dat przy edycji
function handleEdit(praca) {
  validationErrors.value = {};
  // Kopiujemy dane ORAZ formatujemy daty do formatu RRRR-MM-DD
  edytowaneDane.value = { 
    ...praca, 
