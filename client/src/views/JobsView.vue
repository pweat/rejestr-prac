  ...
  <div v-if="showAddJobModal" class="modal-backdrop" @click.self="showAddJobModal = false">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <button type="button" class="close-button" aria-label="Zamknij" @click="showAddJobModal = false">&times;</button>
      </div>
  ...
  <div v-if="showDetailsModal" class="modal-backdrop" @click.self="showDetailsModal = false">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <button type="button" class="close-button" aria-label="Zamknij" @click="showDetailsModal = false">&times;</button>
      </div>
      <div class="modal-body">
  ...
  <div v-if="showEditJobModal" class="modal-backdrop" @click.self="showEditJobModal = false">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <button type="button" class="close-button" aria-label="Zamknij" @click="showEditJobModal = false">&times;</button>
      </div>
