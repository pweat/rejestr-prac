  ...
  <div v-if="showAddJobModal" class="modal-backdrop" @click.self="showAddJobModal = false">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <button type="button" aria-label="Zamknij" class="close-button" @click="showAddJobModal = false">&times;</button>
      </div>
  ...
  <div v-if="showDetailsModal" class="modal-backdrop" @click.self="showDetailsModal = false">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <button type="button" aria-label="Zamknij" class="close-button" @click="showDetailsModal = false">&times;</button>
      </div>
      <div class="modal-body">
  ...
  <div v-if="showEditJobModal" class="modal-backdrop" @click.self="showEditJobModal = false">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <button type="button" aria-label="Zamknij" class="close-button" @click="showEditJobModal = false">&times;</button>
      </div>
