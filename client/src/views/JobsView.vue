  ...
  <div v-if="showAddJobModal" class="modal-backdrop">
    <div class="modal-content modal-lg">
      <div class="modal-header">
        ...
        <button aria-label="Zamknij" class="close-button" @click="showAddJobModal = false">&times;</button>
      </div>
  ...
  <div v-if="showDetailsModal" class="modal-backdrop">
    <div class="modal-content modal-lg">
      <div class="modal-header">
        ...
        <button aria-label="Zamknij" class="close-button" @click="showDetailsModal = false">&times;</button>
      </div>
  ...
  <div v-if="showEditJobModal" class="modal-backdrop">
    <div class="modal-content modal-lg">
      <div class="modal-header">
        ...
        <button aria-label="Zamknij" class="close-button" @click="showEditJobModal = false">&times;</button>
      </div>
      <div class="modal-body">
