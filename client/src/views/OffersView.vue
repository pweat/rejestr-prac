    ...
    <div v-if="showAddOfferModal" class="modal-backdrop">
      <div class="modal-content">
        <div class="modal-header">
          <h3>Nowa Oferta</h3>
          <button aria-label="Zamknij" class="close-button" @click="showAddOfferModal = false">&times;</button>
        </div>
    ...
    <div v-if="showEditOfferModal" class="modal-backdrop">
      <div class="modal-content">
        <div class="modal-header">
          ...
          <button aria-label="Zamknij" class="close-button" @click="showEditOfferModal = false">&times;</button>
        </div>
