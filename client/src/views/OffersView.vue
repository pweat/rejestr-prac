    ...
    <div v-if="showAddOfferModal" class="modal-backdrop">
      <div class="modal-content">
        <div class="modal-header">
          <h3>Nowa Oferta</h3>
          <button type="button" class="close-button" aria-label="Zamknij" title="Zamknij" @click="showAddOfferModal = false">&times;</button>
        </div>
    ...
    <div v-if="showEditOfferModal" class="modal-backdrop">
      <div class="modal-content">
        <div class="modal-header">
          ...
          <button type="button" class="close-button" aria-label="Zamknij" title="Zamknij" @click="showEditOfferModal = false">&times;</button>
        </div>
    ...
    <div v-if="showTemplateManagerModal" class="modal-backdrop">
      <div class="modal-content modal-content--wide">
        <div class="modal-header">
          ...
          <button type="button" class="close-button" aria-label="Zamknij" title="Zamknij" @click="showTemplateManagerModal = false">&times;</button>
        </div>
