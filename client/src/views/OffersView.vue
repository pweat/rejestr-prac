    ...
    <div v-if="showAddOfferModal" class="modal-backdrop">
      <div class="modal-content">
        <div class="modal-header">
          <h3>Nowa Oferta</h3>
          <button type="button" class="close-button" @click="showAddOfferModal = false" aria-label="Zamknij">&times;</button>
        </div>
    ...
    <div v-if="showEditOfferModal" class="modal-backdrop">
      <div class="modal-content">
        <div class="modal-header">
          ...
          <button type="button" class="close-button" @click="showEditOfferModal = false" aria-label="Zamknij">&times;</button>
        </div>
    ...
    <div v-if="showTemplateManagerModal" class="modal-backdrop">
      <div class="modal-content modal-content--wide">
        <div class="modal-header">
          ...
          <button type="button" class="close-button" @click="showTemplateManagerModal = false" aria-label="Zamknij">&times;</button>
        </div>
