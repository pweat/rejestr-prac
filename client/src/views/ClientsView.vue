  ...
  <div v-if="showAddModal" class="modal-backdrop">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <button type="button" class="close-button" aria-label="Zamknij" @click="showAddModal = false">&times;</button>
      </div>
  ...
  <div v-if="showEditModal" class="modal-backdrop">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <button type="button" class="close-button" aria-label="Zamknij" @click="showEditModal = false">&times;</button>
      </div>
