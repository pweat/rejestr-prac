  ...
  <div v-if="showAddModal" class="modal-backdrop">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <button class="close-button" @click="showAddModal = false" aria-label="Zamknij">&times;</button>
      </div>
  ...
  <div v-if="showEditModal" class="modal-backdrop">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <button class="close-button" @click="showEditModal = false" aria-label="Zamknij">&times;</button>
      </div>
