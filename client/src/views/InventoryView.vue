              ...
              <tr v-for="item in inventoryItems" :key="item.id" :class="getItemStatus(item).class.replace('status', 'status-row')">
                ...
                <td data-label="Akcje" class="actions-cell">
                  <div class="actions-cell-inner">
                    ...
                    <button type="button" v-if="userRole === 'admin'" class="usun" @click="handleDeleteItem(item.id)">Usuń</button>
                  </div>
                </td>
              </tr>
            </tbody>
  ...
  <div v-if="showAddItemModal" class="modal-backdrop">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <button type="button" class="close-button" @click="showAddItemModal = false" aria-label="Zamknij">&times;</button>
      </div>
  ...
  <div v-if="showEditItemModal" class="modal-backdrop">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <button type="button" class="close-button" @click="showEditItemModal = false" aria-label="Zamknij">&times;</button>
      </div>
  ...
  <div v-if="showOperationModal" class="modal-backdrop">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <button type="button" class="close-button" @click="showOperationModal = false" aria-label="Zamknij">&times;</button>
      </div>
  ...
  <div v-if="showHistoryModal" class="modal-backdrop">
    <div class="modal-content modal-lg">
      <div class="modal-header">
        ...
        <button type="button" class="close-button" @click="showHistoryModal = false" aria-label="Zamknij">&times;</button>
      </div>
  ...
  <div v-if="showCategoryModal" class="modal-backdrop">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <button type="button" class="close-button" @click="showCategoryModal = false" aria-label="Zamknij">&times;</button>
      </div>
      <div class="modal-body">
            ...
            <li v-for="cat in categories" :key="cat.id">
              ...
              <template v-else>
                ...
                <div class="category-actions">
                  ...
                  <button type="button" class="usun" @click="handleDeleteCategory(cat.id)">Usuń</button>
                </div>
              </template>
            </li>
