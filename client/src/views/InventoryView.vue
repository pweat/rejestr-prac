  ...
  <div v-if="showAddItemModal" class="modal-backdrop">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <button type="button" class="close-button" aria-label="Zamknij" @click="showAddItemModal = false">&times;</button>
      </div>
  ...
  <div v-if="showEditItemModal" class="modal-backdrop">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <button type="button" class="close-button" aria-label="Zamknij" @click="showEditItemModal = false">&times;</button>
      </div>
  ...
  <div v-if="showOperationModal" class="modal-backdrop">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <button type="button" class="close-button" aria-label="Zamknij" @click="showOperationModal = false">&times;</button>
      </div>
  ...
  <div v-if="showHistoryModal" class="modal-backdrop">
    <div class="modal-content modal-lg">
      <div class="modal-header">
        ...
        <button type="button" class="close-button" aria-label="Zamknij" @click="showHistoryModal = false">&times;</button>
      </div>
  ...
  <div v-if="showCategoryModal" class="modal-backdrop">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <button type="button" class="close-button" aria-label="Zamknij" @click="showCategoryModal = false">&times;</button>
      </div>
      <div class="modal-body">
