...
.error-message{color:var(--red);font-size:13px;margin-top:15px;margin-bottom:15px;text-align:center}
@media screen and (max-width: 768px){.table-container table thead{border:none;clip:rect(0 0 0 0);height:1px;margin:-1px;overflow:hidden;padding:0;position:absolute;width:1px}.table-container table tr{display:block;margin-bottom:1em;border:1px solid #ddd;border-radius:6px;padding:1em}.table-container table td{display:block;text-align:left;border-bottom:1px dotted #ccc;padding:8px 0;min-height:1.5em}.table-container table td:last-child{border-bottom:0}.table-container table td::before{content:attr(data-label);display:block;font-weight:700;text-transform:uppercase;font-size:11px;color:#6c757d;margin-bottom:5px}.actions-cell{padding-top:15px;margin-top:10px;border-top:1px dotted #ccc}.actions-cell::before{display:none}.header{flex-direction:column;gap:15px}.modal-content{width:95%;padding:15px}.form-grid{grid-template-columns:1fr;gap:15px}.main-header{padding:0 20px}.main-nav{gap:10px}}
</style>